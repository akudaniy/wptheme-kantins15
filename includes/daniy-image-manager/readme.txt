...
== Changelog ==
= 1.3.1 = 
* Added options to link to image source, not only link to its attachment page. Useful for serving Lightbox gallery
* Added options to insert extended tag attributes like rel="lightbox" or data-toggle="true" to <img> and <a> tags
...
= 1.3.5 =
* Added capabilities to randomize attachments order and limit output number

= 1.3.6 =
* Fixed bug on empty attachment item when randomize_order arguments is set to TRUE
